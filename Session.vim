...
silent only
silent tabonly
cd ~/Library/Mobile\ Documents/com~apple~CloudDocs/AAU/quartz
...
badd +0 content/Getting\ Started.md
argglobal
%argdel
...
argglobal
enew
balt content/Getting\ Started.md
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 135 - ((134 * winheight(0) + 28) / 57)
